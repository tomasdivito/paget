...
import './landing.scss';
const Logos = require.context("../../images");
    ...
    <div className="landing">
      ...
      <div className="social-links">
        <a href="https://www.github.com/tomasdivito">
          <img className="social-link" src={Logos("./Github.svg")} alt="Github logo" />
        </a>
        <a href="https://www.linkedin.com/in/tomas-di-vito">
          <img className="social-link" src={Logos("./Linkedin.svg")} alt="Linkedin logo" />
        </a>
        <a href="https://www.twitter.com/totiiimon">
          <img className="social-link" src={Logos("./Twitter.svg")} alt="Twitter logo" />
        </a>
      </div>
    </div>
  );
